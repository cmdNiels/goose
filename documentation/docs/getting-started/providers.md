...
| [GitHub Copilot](https://docs.github.com/en/copilot/using-github-copilot/ai-models) | Access to GitHub Copilot's chat models including gpt-4o, o1, o3-mini, and Claude models. Uses device code authentication flow for secure access. **When using the CLI set `GOOSE_DISABLE_KEYRING=1`** | Uses GitHub device code authentication flow (no API key needed) |	
